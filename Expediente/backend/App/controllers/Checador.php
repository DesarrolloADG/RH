...
html;
  ...
  public function semanales(){
      ...
      $val = ($user['catalogo_planta_id'] == 1) ? 1 : 5;
          ...
          if($user['perfil_id'] == 6) // Si el usuario es de RH
            $tituloVista = "Checador de Recursos Humanos - Vacaciones " . strtolower($user['nombre_planta']);
  ...
  public function historicosSemanales(){
      ...
      if($user['perfil_id'] == 6){
        ...
        if($user['perfil_id'] == 6) // Si el usuario es de RH
          $tituloVista = "TODOS los Incidencias de Recursos Humanos - Vacaciones " . strtolower($user['nombre_planta']);
  ...
  public function historicosQuincenales(){
    ...
    if($user['perfil_id'] == 6){
      ...
      if($user['perfil_id'] == 6) // Si el usuario es de RH
        $tituloVista = "TODOS Recursos Humanos - Vacaciones " . strtolower($user['nombre_planta']);
  ...
  public function propiosSemanalesHistoricos(){
    ...
    if($user['perfil_id'] == 6){ // Si el usuario es de RH
      $tituloVista = "Checador - Vacaciones " . strtolower($user['nombre_planta']) . " - Depto. " . $user['nombre'];
  ...
  public function propiosQuincenalesHistoricos(){
    ...
    if($user['perfil_id'] == 6){ // Si el usuario es de RH
      $tituloVista = "Checador de Recursos Humanos - Vacaciones " . strtolower($user['nombre_planta']) . " - Depto. " . $user['nombre'];
      $val = ($user['catalogo_planta_id'] == 1) ? 1 : 4;
    }

    if($user['perfil_id'] == 1){ // Si el usuario es de RH
      $tituloVista = "Checador de ROOT - Vacaciones " . strtolower($user['nombre_planta']) . " - Depto. " . $user['nombre'];
  ...
  public function propiosQuincenales(){
    ...
    if($user['perfil_id'] == 6){ // Si el usuario es de RH
      $tituloVista = "Checador propias de Recursos Humanos - Vacaciones " . strtolower($user['nombre_planta']) . " - Depto. " . $user['nombre'];
      $val = ($user['catalogo_planta_id'] == 1) ? 1 : 4;
    }

    if($user['perfil_id'] == 1){ // Si el usuario es de RH
      $tituloVista = "Checador propias - Vacaciones " . strtolower($user['nombre_planta']) . " - Depto. " . $user['nombre'];
      $estatusRH = ($user['perfil_id'] == 1) ? 2 : 0;
      $val = 4; // TIENE INCENTIVOS PROPIOS
    }
