      ...
      foreach ($departamentos as $key => $value) {
        $tabla.=<<<html
                <tr>
                    ...
                    <td>{$value['status']}</td>
                    <td class="center" >
                        <a href="/Economicos/edit/{$value['catalogo_departamento_id']}" {$editarHidden} type="submit" name="id" class="btn btn-primary"><span class="fa fa-pencil-square-o" style="color:red"></span> </a>
                        <a href="/Economicos/show/{$value['catalogo_departamento_id']}" type="submit" name="id_empresa" class="btn btn-success"><span class="glyphicon glyphicon-eye-open" style="color:white"></span> </a>
                    </td>
                </tr>
...
html;
  ...
  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    <div class="panel panel-default">
      ...
      <form name="delete-form" name="all" id="all" action="/Economicos/delete" method="POST">
