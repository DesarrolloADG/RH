          ...
          $("#add").validate({
            ...
            messages:{
              ...
              puerto: {
                ...
                maxlength: "Este campo debe tener maximo 4 caracteres",
                digits: "No se aceptan letras, solo numeros"
              },
              descripcion: {
                required: "Este campo es requerido",
...
html;
      ...
      $ubicacionId = lectoresDao::getUbicacionId();
      $optionUbicacionId = '';
      foreach ($ubicacionId as $key => $val1) {
        $optionUbicacionId .= <<<html
        <option value="{$val1['catalogo_ubicacion_id']}">{$val1['nombre']}</option>
html;
      }
