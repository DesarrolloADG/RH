...
<div class="right_col">
    ...
    <div>
        <div class="x_panel">
            <div class="x_title">
                <h2>Asistentes de la Capacitación <small>ADG - RH</small></h2>
                <div class="clearfix"></div>
            </div>
            ...
            <div class="x_content">
                ...
                <div class="panel-body" <?php echo $visible; ?>>
                        ...
                        <div class="x_panel">
                        <div class="x_title">
                            <h2>Seleccione cada Colaborador a participar en la capacitación</h2>
                            ...
                            <form enctype="multipart/form-data" id="form_colaboradores">
                                <div class="x_content">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" id="id_capacitacion" name="id_capacitacion" value = "<?php echo $clave; ?>" >
                                    </div>
...
function gt (){
    ...
    else
    {
        ...
        xhttp.open("POST", "/RegistroCapacitaciones/ParticipanteAdd", true);
        xhttp.send(data);
...
function gt_1 (a){
    ...
    alertify.confirm('¿Segúro que desea eliminar lo seleccionado?', function(response) {
        ...
        $.ajax({
            type: "POST",
            async: false,
            url: "/RegistroCapacitaciones/delete", // script to validate in server side
            data: {a: a},
