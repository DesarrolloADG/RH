                ...
                <form class="form-horizontal" id="add" action="/Colaboradores/colaboradorAdd" method="POST" enctype="multipart/form-data">
                    <div class="form-group ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="id_catalogo_lector" id="id_catalogo_lector">
                                    <option value="0">Selecciona un lectos del Catálogo del Lectores</option>
                                    <?php echo $idLector; ?>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="numero_identificacion" id="numero_identificacion" class="form-control col-md-7 col-xs-12" placeholder="Ingresa el número de Identificación" disabled="true">
                            </div>
                      ...
                      <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                        ...
                        <div class="form-group">
                            <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-2 col-xs-offset-3">
                                ...
                                <button class="btn btn-success col-md-3 col-sm-3 col-xs-5" id="btnAdd" type="submit" disabled="true">Agregar</button>
                            </div>
                        </div>
                    </div>
                </form>
