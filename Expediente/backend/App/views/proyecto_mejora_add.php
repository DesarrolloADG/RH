            ...
            <div class="col align-self-center">
                <div class="center-block">
                    <div class="row">
                        <div class="col-md-10">
                                <div class="x_content">
                                    <form class="form-label-left input_mask" id="add" action="/ProyectosMejora/ProyectosAdd" method="POST">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading text-center">
                                                            ...
                                                            <span><strong><span class="glyphicon glyphicon-hdd"></span> Alta de Proyecto de Mejora ADG</strong>
                                                            </span>
                                                        </div>
                                                            ...
                                                            <div class="x_content">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                                                        <input type="text" name="nombrep" id="nombrep" class="form-control col-md-7 col-xs-12" placeholder="Ej. ANÁLISIS FODA PRODUCCIÓN">
                                                                    </div>
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                                                        <textarea class="form-control" name="detalle" id="detalle" cols="40" rows="8" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="OBJETIVOS, MISIÓN, VISIÓN, ALCANCES"></textarea>
                                                                    </div>
                                                                </div>
                                                                <br>
                                                                <div class="form-group col-md-12">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <div class="col-md-12 col-sm-6 col-xs-12">
                                                                        <textarea class="form-control" name="detalle1" id="detalle1" cols="40" rows="5" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" placeholder="OBJETIVOS, MISIÓN, VISIÓN, ALCANCES"></textarea>
                                                                    </div>
                                                                </div>
                                                                <br>
