                                                        ...
                                                        <div class="panel-body">
                                                            <div class="x_content">
                                                                    ...
                                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12" for="tipo_encuesta">Tipo de Encuesta<span class="required">*</span></label>
                                                                        <div class="col-md-8 col-sm-6 col-xs-12">
                                                                            <select class="form-control" name="tipo_encuesta" id="tipo_encuesta">
                                                                                <option value="" disabled selected>Selecciona un Tipo de Encuesta</option>
                                                                                <?php echo $idEncuesta; ?>
                                                                            </select>
                                                                        </div>
                                                                ...
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                                                        <input type="date" name="fecha_inicio" id="fecha_inicio" class="form-control col-md-7 col-xs-12">
                                                                    </div>
                                                                    <span id="availability"></span>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-5">
                                                                    ...
                                                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                                                        <input type="date" name="fecha_final" id="fecha_final" class="form-control col-md-7 col-xs-12" >
                                                                    </div>
                                                                    <span id="availability"></span>
                                                                </div>
                                                                <span id="availability"></span>
