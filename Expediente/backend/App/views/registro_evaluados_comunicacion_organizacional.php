...
<div class="right_col">
    ...
    <div>
        <div class="x_panel">
            <div class="x_title">
                <h2>Registrar Colaboradores a Evaluar la Comunicación Organizacional <small>ADG - RH</small></h2>
                <div class="clearfix"></div>
            </div>
            ...
            <div class="x_content">
                ...
                <div class="panel-body" <?php echo $visible; ?>>
                        ...
                        <div class="x_panel">
                        <div class="x_title">
                            <h2>Seleccione cada Colaborador a participar en la Evaluación</h2>
                            ...
                            <form enctype="multipart/form-data" id="form_colaboradores">
                                <div class="x_content">
                                    <div class="form-group col-md-9">
                                        ...
                                        <input type="hidden" class="form-control" id="id_encuesta" name="id_encuesta" value="<?php echo $id_encuesta; ?>">
...
function gt (){
    ...
    else
    {
        ...
        xhttp.open("POST", "/Encuestas/EncuestasComunicacionOrganizacionalAdd", true);
        xhttp.send(data);
