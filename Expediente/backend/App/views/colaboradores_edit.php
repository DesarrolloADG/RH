                ...
                <form class="form-horizontal" id="edit" action="/Colaboradores/colaboradorEdit" method="POST" enctype="multipart/form-data">
                    <div class="form-group ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control" name="catalogo_lector_id" id="catalogo_lector_id" disabled="true">
                                    <?php echo $idLector; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="numero_identificacion" id="numero_identificacion" class="form-control col-md-7 col-xs-12" placeholder="Ingresa el número de Identificación" value="<?php echo $colaborador['numero_identificador']; ?>" disabled="true">
                            </div>
                        </div>
