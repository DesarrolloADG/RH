...
<div class="right_col">
    ...
    <div>
        <div class="x_panel">
            <div class="x_title">
                <h2>Bitacora Contabilidad de Vacaciones <small>ADG - RH</small></h2>
                <div class="clearfix"></div>
            </div>
            ...
            <div class="container">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a data-toggle="tab" href="#home">Registro Colaboradores Producción</a>
                    </li>
                    <li>
                        <a data-toggle="tab" href="#menu1">Contabilidad Vacaciones Administrativos</a>
                    </li>
                </ul>
